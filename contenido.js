...
(function () {
  ...
  var TEXTO_MATRIX = [
    ...
    "* Por debajo del último escalón, ¿cuánto le pagan ese día?",
    "+ Nada: le restan. Es una penalización en negativo. | En M0-PP son menos seis mil pesos por día, y en otras categorías cifras parecidas.",
    "x Cero pesos, pero nunca en contra. | El sistema sí resta por debajo del último escalón.",
    "x El mínimo del escalón más bajo. | Ese mínimo solo aplica si lo alcanza.",
